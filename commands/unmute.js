...
if (message.content === prefix+"unmute"){
    ...
    if(message.mentions.users.size === 0) {
        return message.reply(" :x: Proszę oznacz osobę aby ją odciszyć :x:").catch(console.error);
}
...
if (message.author.bot) return
    memberr.removeRole(muted) + message.channel.sendMessage(`Odciszono gracza ${memberr} :mute:`).catch(console.error);
}
}
module.exports.help = {
    name: "unmute"
